    ...
    <div className="form-control">
      ...
      <div className="input-group text-center md:flex mt-3">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
          ...
          <input type="email" className="grow" placeholder="Email" onInput={(e) =>{ setEmail((e.target as HTMLInputElement).value); }} />
        </label>
      
          <button className="btn btn-primary align-middle md:ml-3 w-72 md:w-52 mt-4 md:mt-0" onClick={startTracking}>
